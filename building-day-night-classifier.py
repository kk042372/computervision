...
print("Shape: "+str(selected_image.shape)) print("Label: " + str(selected_label))
...
#Display image and data about it
#Make sure the images have numerical labels and are of the same size
plt.imshow(selected_image) 
print("Shape: "+str(selected_image.shape)) print("Label [1 = day, 0 = night]: " + str(selected_label))
